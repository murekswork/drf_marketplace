    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('searching', 'Searching'), (
                    'in-process', 'In Process'), ('delivered', 'Delivered'), ('canceled', 'Canceled')], max_length=10)),
                ...
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='delivery', to='order.order')),
            ],
        ),
    ]
