...
class WalletModelTestCase(TestCase):
    ...
    def setUp(self):
        self.user1 = get_user_model().objects.create_user(username='user1', email='user1@mail')
        self.user1.set_password('0xABAD1DEA')
        self.user2 = get_user_model().objects.create_user(username='user2', email='user2@mail')
